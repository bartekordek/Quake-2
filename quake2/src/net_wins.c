...
char *NET_AdrToString (netadr_t a)
{
	...
	if (a.type == NA_LOOPBACK)
		...
		Com_sprintf (s, sizeof (s), "%02x%02x%02x%02x:%02x%02x%02x%02x%02x%02x:%i", a.ipx[0], a.ipx[1], a.ipx[2], a.ipx[3], a.ipx[4],
...
int NET_IPXSocket (int port)
{
	...
	// make it broadcast capable
	if (setsockopt (newsocket, SOL_SOCKET, SO_BROADCAST, (const char *) &_true, sizeof (_true)) == -1)
	{
...
{
	NET_Config (e_false);  // close sockets
