                  ...
                  int* height )
{
    ...
    *pic = NULL;
    ...
    if( !raw )
        return;  // Com_Printf_C ("Bad pcx file %s\n", filename);
    ...
    *pic = out;
    ...
    if( raw - (byte*)pcx > len )
    {
        Com_Printf_C( "PCX file %s was malformed", filename );
        Z_Free( *pic );
        *pic = NULL;
    }
...
cblock_t Huff1Decompress( cblock_t in )
{
    ...
    {
        Com_Printf_C( "Decompression overread by %i",
...
void SCR_RunCinematic( void )
{
    ...
    {
        Com_Printf_C( "Dropped frame: %i > %i\n", frame,
                      cl.cinematicframe + 1 );
        cl.cinematictime = cls.realtime - cl.cinematicframe * 1000 / 14;
    }
    if( cin.pic )
