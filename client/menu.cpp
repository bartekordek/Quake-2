...
static void KeyCursorDrawFunc( menuframework_s *menu )
{
    if ( bind_grab )
        ...
        re.DrawChar( menu->x, menu->y + menu->cursor * 9, 12 + ( ( int ) ( win32_Sys_Milliseconds() / 250 ) & 1 ) );
}
...
void PlayerConfig_MenuDraw( void )
{
    ...
    if ( s_pmi[s_player_model_box.curvalue].skindisplaynames )
    {
        ...
        //Com_sprintf( scratch, sizeof( scratch ), "/players/%s/%s_i.pcx", s_pmi[s_player_model_box.curvalue].directory, s_pmi[s_player_model_box.curvalue].skindisplaynames[s_player_skin_box.curvalue] );
...
const char *PlayerConfig_MenuKey (int key)
{
    ...
    if ( key == K_ESCAPE )
    {
        ...
        //Com_sprintf( scratch, sizeof( scratch ), "%s/%s", s_pmi[s_player_model_box.curvalue].directory, s_pmi[s_player_model_box.curvalue].skindisplaynames[s_player_skin_box.curvalue] );
