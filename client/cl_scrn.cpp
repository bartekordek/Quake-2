...
void SCR_Sky_f (void)
{
    ...
    if (Cmd_Argc() < 2)
    {
        Com_Printf_G ("Usage: sky <basename> <rotate> <axis x y z>\n");
        return;
    }
    if (Cmd_Argc() > 2)
...
void SCR_BeginLoadingPlaque (void)
{
    ...
    if (cl.cinematictime > 0)
        ...
        scr_draw_loading = 1;
    SCR_UpdateScreen();
    cls.disable_screen = win32_Sys_Milliseconds ();
...
================
*/
int entitycmpfnc( const entity_s *a, const entity_s *b )
{
    /*
...
void SCR_UpdateScreen (void)
{
    ...
    if (cls.disable_screen)
    {
        if (win32_Sys_Milliseconds() - cls.disable_screen > 120000)
        {
            cls.disable_screen = 0;
            Com_Printf_G ("Loading plaque timed out.\n");
        }
        return;
    }
