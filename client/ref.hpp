...
typedef struct
{
    ...
    void    (*BeginRegistration) (const std::string& map);
    struct model_s *(*RegisterModel) (const std::string& name);
    struct image_s *(*RegisterSkin) (const std::string& name);
    struct image_s *(*RegisterPic) (const std::string& name);
    void    (*SetSky) (const std::string& name, float rotate, vec3_t axis);
    void    (*EndRegistration) (void);

    void    (*RenderFrame) (refdef_t *fd);

    void    (*DrawGetPicSize) (int *w, int *h, const std::string& name);    // will return 0 0 if not found
    void    (*DrawPic) (int x, int y, const std::string& name);
    void    (*DrawStretchPic) (int x, int y, int w, int h, const std::string& name);
    void    (*DrawChar) (int x, int y, int c);
    void    (*DrawTileClear) (int x, int y, int w, int h, const std::string& name);
...
typedef struct
{
    ...
    int        (*FS_LoadFile) (const std::string& name, void **buf);
