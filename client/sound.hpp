...
void S_StartLocalSound (const std::string& s);
...
struct sfx_s *S_RegisterSound (const std::string& sample);
void S_EndRegistration (void);

struct sfx_s *S_FindName (const std::string& name, bool create);
