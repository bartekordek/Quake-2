...
// find a free beam
	...
	Com_Printf_G ("beam list overflow!\n");
	return ent;
}
...
void CL_ParseSteam (void)
{
	...
	if (id != -1) // sustains
	{
//			Com_Printf_G ("Sustain effect id %d\n", id);
		free_sustain = NULL;
