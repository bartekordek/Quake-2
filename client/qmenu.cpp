...
void Menu_Draw( menuframework_s *menu )
{
    ...
    */
    ...
    else if ( item && item->type != MTYPE_FIELD )
    {
        ...
        {
            Draw_Char( menu->x + item->x - 24 + item->cursor_offset, menu->y + item->y, 12 + ( ( int ) ( win32_Sys_Milliseconds()/250 ) & 1 ) );
        }
        else
        {
            Draw_Char( menu->x + item->cursor_offset, menu->y + item->y, 12 + ( ( int ) ( win32_Sys_Milliseconds()/250 ) & 1 ) );
        }
    }
