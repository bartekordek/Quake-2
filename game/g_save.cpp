...
field fields[] = {
    ...
    {"stand", FOFS(monsterinfoVal.stand), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"idle", FOFS(monsterinfoVal.idle), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"search", FOFS(monsterinfoVal.search), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"walk", FOFS(monsterinfoVal.walk), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"run", FOFS(monsterinfoVal.run), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"dodge", FOFS(monsterinfoVal.dodge), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"attack", FOFS(monsterinfoVal.attack), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"melee", FOFS(monsterinfoVal.melee), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"sight", FOFS(monsterinfoVal.sight), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"checkattack", FOFS(monsterinfoVal.checkattack), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
    {"currentmove", FOFS(monsterinfoVal.currentmove), fieldtype_t::F_MMOVE, FFL_NOSPAWN},

    {"endfunc", FOFS(moveinfoVal.endfunc), fieldtype_t::F_FUNCTION, FFL_NOSPAWN},
