...
void soldier_pain (edict *self, edict *other, float kick, int damage)
{
    float    r;
    int	    n;
...
void soldier_fire (edict *self, int flash_number)
{
    vec3_t    start;
...
void soldier_fire1 (edict *self)
{
    soldier_fire (self, 0);
}

void soldier_attack1_refire1 (edict *self)
{
    if (self->s.skinnum > 1)
	    return;
...
void soldier_fire2 (edict *self)
{
    soldier_fire (self, 1);
}

void soldier_attack2_refire1 (edict *self)
{
    if (self->s.skinnum > 1)
	    return;
...
void soldier_fire5 (edict *self)
{
    soldier_fire (self, 4);
}

void soldier_attack5_refire (edict *self)
{
    if (self->enemy->health <= 0)
	    return;
...
void soldier_fire8 (edict *self)
{
    soldier_fire (self, 7);
}

void soldier_attack6_refire (edict *self)
{
    if (self->enemy->health <= 0)
	    return;
...
void soldier_attack(edict *self)
{
    if (self->s.skinnum < 4)
	{
	    if (random() < 0.5)
...
void soldier_dodge (edict *self, edict *attacker, float eta)
{
    float    r;
...
void soldier_fire6 (edict *self)
{
    soldier_fire (self, 5);
}

void soldier_fire7 (edict *self)
{
    soldier_fire (self, 6);
}

void soldier_dead (edict *self)
{
...
void soldier_die (edict *self, edict *inflictor, edict *attacker, int damage, vec3_t point)
{
    int	    n;
