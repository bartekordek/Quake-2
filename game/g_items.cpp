...
void DoRespawn( edict* ent )
{
    ...
    quake2::getInstance()->quake2::getInstance()->gi.linkentity( ent );
...
void Use_Quad( edict* ent, gitem* item )
{
    ...
    quake2::getInstance()->gi.sound(
        ent, CHAN_ITEM,
        quake2::getInstance()->gi.soundindex( "items/damage.wav" ), 1,
        ATTN_NORM, 0 );
}
...
void Use_Breather( edict* ent, gitem* item )
{
    ...
    //    quake2::getInstance()->gi.sound(ent, CHAN_ITEM,
    //    quake2::getInstance()->gi.soundindex("items/damage.wav"), 1,
    //    ATTN_NORM, 0);
}
...
void Use_Invulnerability( edict* ent, gitem* item )
{
    ...
    quake2::getInstance()->gi.sound(
        ent, CHAN_ITEM,
        quake2::getInstance()->gi.soundindex( "items/protect.wav" ), 1,
        ATTN_NORM, 0 );
}
...
void Use_PowerArmor( edict* ent, gitem* item )
{
    ...
    if ( ent->flags & FL_POWER_ARMOR )
    {
        ...
        quake2::getInstance()->gi.sound(
            ent, CHAN_AUTO,
            quake2::getInstance()->gi.soundindex( "misc/power2.wav" ), 1,
            ATTN_NORM, 0 );
    }
    else
    {
        ...
        quake2::getInstance()->gi.sound(
            ent, CHAN_AUTO,
            quake2::getInstance()->gi.soundindex( "misc/power1.wav" ), 1,
            ATTN_NORM, 0 );
    }
}
...
void Touch_Item( edict* ent, edict* other, plane_s* plane, csurface_s* surf )
{
    ...
    if ( taken )
    {
        ...
        other->client->ps.stats[STAT_PICKUP_ICON] =
            quake2::getInstance()->gi.imageindex( ent->item->icon );
...
static void drop_temp_touch( edict* ent, edict* other, plane_s* plane,
                             csurface_s* surf )
{
    if ( other == ent->owner )
        return;
...
edict* Drop_Item( edict* ent, gitem* item )
{
    ...
    if ( ent->client )
    {
        ...
        trace = quake2::getInstance()->gi.trace(
            ent->s.origin, dropped->mins, dropped->maxs, dropped->s.origin, ent,
            CONTENTS_SOLID );
...
void PrecacheItem( gitem* it )
{
    ...
    while ( *s )
    {
        ...
        if ( len >= MAX_QPATH || len < 5 )
            quake2::getInstance()->gi.error(
                "PrecacheItem: %s has bad precache string", it->classname );
...
void SpawnItem( edict* ent, gitem* item )
{
    ...
    ent->item = item;
    ent->nextthink =
        level.time + 2 * FRAMETIME;  // items start after other solids
...
gitem itemlist[] = {
    ...
    { "item_power_screen", Pickup_PowerArmor, Use_PowerArmor, Drop_PowerArmor,
      NULL, "misc/ar3_pkup.wav", "models/items/armor/screen/tris.md2",
      EF_ROTATE, NULL,
      /* icon */ "i_powerscreen",
      /* pickup */ "Power Screen",
    ...
    { "item_power_shield", Pickup_PowerArmor, Use_PowerArmor, Drop_PowerArmor,
      NULL, "misc/ar3_pkup.wav", "models/items/armor/shield/tris.md2",
      EF_ROTATE, NULL,
      /* icon */ "i_powershield",
      /* pickup */ "Power Shield",
      /* width */ 0, 60, NULL, IT_ARMOR, 0, NULL, 0,
    ...
    */
    { "weapon_blaster", NULL, Use_Weapon, NULL, Weapon_Blaster,
      ...
      /* icon */ "w_blaster",
      /* pickup */ "Blaster", 0, 0, NULL, IT_WEAPON | IT_STAY_COOP,
      WEAP_BLASTER, NULL, 0,
    ...
    { "weapon_supershotgun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
      Weapon_SuperShotgun, "misc/w_pkup.wav",
     ...
     */
    { "weapon_chaingun", Pickup_Weapon, Use_Weapon, Drop_Weapon,
      Weapon_Chaingun, "misc/w_pkup.wav", "models/weapons/g_chain/tris.md2",
    ...
    { "weapon_hyperblaster", Pickup_Weapon, Use_Weapon, Drop_Weapon,
      Weapon_HyperBlaster, "misc/w_pkup.wav",
     ...
     */
    { "item_quad", Pickup_Powerup, Use_Quad, Drop_General, NULL,
      "items/pkup.wav", "models/items/quaddama/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_quad",
      /* pickup */ "Quad Damage",
      /* width */ 2, 60, NULL, IT_POWERUP, 0, NULL, 0,
      /* precache */ "items/damage.wav items/damage2.wav items/damage3.wav" },

    /*QUAKED item_invulnerability (.3 .3 1) (-16 -16 -16) (16 16 16)
     */
    { "item_invulnerability", Pickup_Powerup, Use_Invulnerability, Drop_General,
      NULL, "items/pkup.wav", "models/items/invulner/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_invulnerability",
      /* pickup */ "Invulnerability",
      /* width */ 2, 300, NULL, IT_POWERUP, 0, NULL, 0,
      /* precache */
      "items/protect.wav items/protect2.wav items/protect4.wav" },

    /*QUAKED item_silencer (.3 .3 1) (-16 -16 -16) (16 16 16)
     */
    { "item_silencer", Pickup_Powerup, Use_Silencer, Drop_General, NULL,
      "items/pkup.wav", "models/items/silencer/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_silencer",
      /* pickup */ "Silencer",
      /* width */ 2, 60, NULL, IT_POWERUP, 0, NULL, 0,
      /* precache */ "" },
     ...
     */
    { "item_breather", Pickup_Powerup, Use_Breather, Drop_General, NULL,
      "items/pkup.wav", "models/items/breather/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_rebreather",
      /* pickup */ "Rebreather",
      /* width */ 2, 60, NULL, IT_STAY_COOP | IT_POWERUP, 0, NULL, 0,
      /* precache */ "items/airout.wav" },

    /*QUAKED item_enviro (.3 .3 1) (-16 -16 -16) (16 16 16)
     */
    { "item_enviro", Pickup_Powerup, Use_Envirosuit, Drop_General, NULL,
      "items/pkup.wav", "models/items/enviro/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_envirosuit",
    ...
    */
     ...
     */
    { "item_bandolier", Pickup_Bandolier, NULL, NULL, NULL, "items/pkup.wav",
      "models/items/band/tris.md2", EF_ROTATE, NULL,
      /* icon */ "p_bandolier",
      /* pickup */ "Bandolier",
      /* width */ 2, 60, NULL, 0, 0, NULL, 0,
      /* precache */ "" },
     ...
     */
    { "item_pack", Pickup_Pack, NULL, NULL, NULL, "items/pkup.wav",
      "models/items/pack/tris.md2", EF_ROTATE, NULL,
      /* icon */ "i_pack",
      /* pickup */ "Ammo Pack",
      /* width */ 2, 180, NULL, 0, 0, NULL, 0,
      /* precache */ "" },
    ...
    */
    { "key_data_cd", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
    ...
    */
    { "key_power_cube", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
    ...
    */
    { "key_pyramid", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
    ...
    */
    { "key_data_spinner", Pickup_Key, NULL, Drop_General, NULL,
      "items/pkup.wav", "models/items/keys/spinner/tris.md2", EF_ROTATE, NULL,
      "k_dataspin", "Data Spinner", 2, 0, NULL, IT_STAY_COOP | IT_KEY, 0, NULL,
      0,
      /* precache */ "" },
    ...
    */
    { "key_pass", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
    ...
    */
    { "key_blue_key", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
      "models/items/keys/key/tris.md2", EF_ROTATE, NULL, "k_bluekey",
      "Blue Key", 2, 0, NULL, IT_STAY_COOP | IT_KEY, 0, NULL, 0,
      /* precache */ "" },

    /*QUAKED key_red_key (0 .5 .8) (-16 -16 -16) (16 16 16)
    normal door key - red
    */
    { "key_red_key", Pickup_Key, NULL, Drop_General, NULL, "items/pkup.wav",
    ...
    */
    { "key_commander_head", Pickup_Key, NULL, Drop_General, NULL,
      ...
      /* width */ 2, 0, NULL, IT_STAY_COOP | IT_KEY, 0, NULL, 0,
      /* precache */ "" },

    /*QUAKED key_airstrike_target (0 .5 .8) (-16 -16 -16) (16 16 16)
    tank commander's head
    */
    { "key_airstrike_target", Pickup_Key, NULL, Drop_General, NULL,
      "items/pkup.wav", "models/items/keys/target/tris.md2", EF_ROTATE, NULL,
      /* icon */ "i_airstrike",
...
void SetItemNames( void )
{
    ...
    {
        it = &itemlist[i];
        quake2::getInstance()->gi.configstring( CS_ITEMS + i,
                                                 it->pickup_name );
    }
