#ifndef ____QCOMMON_QCOMMON_QCOMMON_H__
#define ____QCOMMON_QCOMMON_QCOMMON_H__
...
trace_t CM_TransformedBoxTrace( vec3_t start, vec3_t end, vec3_t mins, vec3_t maxs, int headnode, int brushmask, vec3_t origin,
                                vec3_t angles );
...
#endif  // ____QCOMMON_QCOMMON_QCOMMON_H__