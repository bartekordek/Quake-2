...
static int RGBattributes[] = {
	GLX_DOUBLEBUFFER, GLX_RGBA, GLX_RED_SIZE, 4, GLX_GREEN_SIZE, 4, GLX_BLUE_SIZE, 4, GLX_DEPTH_SIZE, 1, None,
};
...
// If not specified, use default visual
	...
	// setup attributes for main window
	{
		...
		x_win				 = XCreateWindow (x_disp, root_win, 0, 0,  // x, y
	...
	if (fullscreen)
	{
		...
		else
		{
			...
			XChangeProperty (x_disp, x_win, aHints, aHints, 32, PropModeReplace, (unsigned char *) &wmhints, 4);
			...
			XConfigureWindow (x_disp, x_win, CWX | CWY | CWWidth | CWHeight | CWStackMode, &changes);
		}
	}
