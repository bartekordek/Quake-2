...
int CDAudio_Init(void)
{
    ...
    dwReturn = mciSendCommand( 2, MCI_OPEN, MCI_OPEN_TYPE | MCI_OPEN_SHAREABLE, ( DWORD_PTR ) ( LPVOID ) &mciOpenParms );
    ...
    if( dwReturn )
	{
	    ...
	    string = "";
	    size = 0;
	    mciGetErrorString( dwReturn, string, size );

	    Com_Printf_G("CDAudio_Init: MCI_OPEN failed (%i)\n", dwReturn);
	    return -1;
	}
    ...
    if (dwReturn = mciSendCommand(wDeviceID, MCI_SET, MCI_SET_TIME_FORMAT, (DWORD)(LPVOID) &mciSetParms))
    {
	    ...
	    Com_Printf_G("MCI_SET_TIME_FORMAT failed (%i)\n", dwReturn);
