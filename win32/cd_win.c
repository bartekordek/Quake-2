...
static void CDAudio_Eject( void )
{
    ...
    // if( dwReturn = mciSendCommand( wDeviceID, MCI_SET, MCI_SET_DOOR_OPEN,
    //                                (DWORD)NULL ) )
...
static void CDAudio_CloseDoor( void )
{
    ...
    // if( dwReturn = mciSendCommand( wDeviceID, MCI_SET, MCI_SET_DOOR_CLOSED,
    //                                (DWORD)NULL ) )
...
void CDAudio_Pause( void )
{
    ...
    // if( dwReturn = mciSendCommand( wDeviceID, MCI_PAUSE, 0,
...
static void CD_f( void )
{
    ...
    //         return;
    //     }
    //     for( n = 1; n <= ret; n++ ) remap[n] = atoi( Cmd_Argv( n + 1 ) );
    //     return;
    // }
