...
void Sys_Error_G( char* error, ... )
{
    ...
    quake2::getInstance()->quake2::getInstance()->gi.error( ERR_FATAL, "%s",
                                                              text );
}
...
void Com_Printf_G( char* msg, ... )
{
    ...
    quake2::getInstance()->quake2::getInstance()->gi.dprintf( "%s", text );
}
