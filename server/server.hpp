...
int Edict_idx( edict* edict );

//#define EDICT_NUM(n) ((edict *)((byte *)quake2::getInstance()->ge.edicts + quake2::getInstance()->ge.edict_size*(n)))
// #define NUM_FOR_EDICT( e ) \
//     ( ( (byte*)( e ) - (byte*)quake2::getInstance()->ge.edicts ) / quake2::getInstance()->ge.edict_size )

enum server_client_state_t
{
...
typedef struct client_s
{
    ...
    usercmd_s lastcmd;  // for filling in big drops
