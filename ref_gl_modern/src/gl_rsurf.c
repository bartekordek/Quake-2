...
void R_DrawAlphaSurfaces (void)
{
	...
	{
		GL_BindTexture (s->texinfo->image->texnum);
		c_brush_polys++;
...
static void LM_UploadBlock (qboolean dynamic)
{
	...
	{
		qglTexImage2D (GL_TEXTURE_2D, 0, gl_lms.internal_format, BLOCK_WIDTH, BLOCK_HEIGHT, 0, GL_LIGHTMAP_FORMAT, GL_UNSIGNED_BYTE,
